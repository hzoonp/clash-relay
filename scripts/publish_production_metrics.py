...
from clash_relay.production_application import persist_production_metrics
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = persist_production_metrics(project=project, private_dir=args.private_dir)
