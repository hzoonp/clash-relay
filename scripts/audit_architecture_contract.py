...
def main() -> int:
    ...
    if 'version = "2.1.0"' not in pyproject or '__version__ = "2.1.0"' not in package:
        raise SystemExit("architecture audit: v2.1.0 package version boundary is incomplete")
